...
import AkiroinuAkiroAkiroinuAkiroAkiro from './akiroinu/akiro/akiroinu.akiro.akiro'
...
export default { 
  AkiroinuAkiroAkiroinuAkiroAkiro: load(AkiroinuAkiroAkiroinuAkiroAkiro, 'akiroinu.akiro.akiro'),
